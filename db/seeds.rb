...
pet2 = Pet.new(species: "elephant", name: "Dumbo", user: user1)
...
pet4 = Pet.new(species: "lion", name: "The King", user: user1)
...
pet5 = Pet.new(species: "scorpion", name: "The killer", user: user1)
...
pet6 = Pet.new(species: "iguane", name: "Bob", user: user1)
...
pet7 = Pet.new(species: "parrot", name: "The Singer", user: user1)
...
pet8 = Pet.new(species: "wolf", name: "The wild", user: user1)
...
pet9 = Pet.new(species: "panda", name: "The Teddy Bear", user: user1)
